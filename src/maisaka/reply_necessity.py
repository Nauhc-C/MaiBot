...
REPLY_NECESSITY_TRIGGER_SCORE = 80  # 大幅降低阈值，让更多消息进入Planner，由Planner根据注入的必要性提示决策
...
REPLY_NECESSITY_RECENT_SELF_RATIO_FREE = 0.15
REPLY_NECESSITY_RECENT_SELF_RATIO_FULL = 0.50
REPLY_NECESSITY_RECENT_SELF_PENALTY_MAX = 35
